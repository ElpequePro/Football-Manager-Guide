...
function Striker() {
    ...
    return (
        <main>
            ...
            <article>
            <h2 id="deep-lying-forward-role" className="role-title">Deep Lying Forward</h2>
            ...
            <article>
            <h2 id="advanced-forward-role" className="role-title">Advanced Forward</h2>
            ...
            <article>
            <h2 id="target-forward-role" className="role-title">Target Forward</h2>
            ...
            <article>
            <h2 id="poacher-role" className="role-title">Poacher</h2>
            ...
            <article>
            <h2 id="complete-forward-role" className="role-title">Complete Forward</h2>
            ...
            <article>
            <h2 id="pressing-forward-role" className="role-title">Pressing Forward</h2>
            ...
            <article>
                <h2 id="false-nine-role" className="role-title">False Nine</h2>
